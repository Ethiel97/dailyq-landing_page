                ...
                <nav>
                    <div className="flex justify-between items-center">
                        ...
                        <div className="lg:hidden">
                            <button ref={navBurger} onClick={handleNavBurger} className="navbar-burger flex items-center p-3 hover:bg-gray-50 rounded">
                        ...
                        <div className="hidden lg:block"><a className="myButton" href="mailto:ethiel97@gmail.com">Contact Us</a></div>
                    </div>
                </nav>
            </div>
            <div ref={navMenu} className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
                <div ref={navBackdrop} onClick={handleNavBackdrop} className="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25"></div>
