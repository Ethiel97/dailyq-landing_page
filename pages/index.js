...
export default function Home() {
    ...
    const playStoreLink = "https://play.google.com/store/apps/details?id=com.deventhusiast.quotes.smart_quotes";
    return (
        <>
            <section className="relative py-20">
                <Image className="hidden lg:block absolute top-0 left-0 mt-24" layout='raw' src={BlueDotLeftBars} alt="" />
                <div className="relative container px-4 mx-auto">
                    <div className="flex flex-wrap items-center -mx-4">
                        <div className="w-full md:w-3/5 px-4 mb-16 md:mb-0">
                            <h2 className="mb-10 text-4xl font-semibold font-heading">Get your Best Quotes App</h2>
                            <div className="max-w-xl">
                                <p className="mb-10 text-xl text-gray-500">dailyQ is a mobile app that provides with you the best quotes from celebrities, famous authors, scientists. Ever wanted to learn new quotes everyday? This is the best app for you</p>
                            </div>
                        ...
                        <div className="w-full md:w-2/5 px-4 translateY">
                            <Image layout='raw' className="h-96 object-contain lg:h-auto mx-auto" src={Screenshot1} alt="" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id='about' className="relative pb-20 lg:py-20">
                ...
                <div className="container px-4 mx-auto">
                    <div className="w-full lg:w-7/12 lg:ml-auto">
                        <Image layout='raw' className="hidden lg:block lg:absolute ml-auto top-0 right-0 lg:mt-64" src={YellowDotRightShield} alt="" />
                        <div className="max-w-md lg:mx-auto">
                            <h2 className="mb-10 lg:mb-16 text-4xl font-semibold font-heading">Awesome Features</h2>
                            <div className="flex items-start mb-10">
                                ...
                                <div className="max-w-sm">
                                    <h3 className="mb-6 text-2xl font-semibold font-heading">Great quotes</h3>
                                    <p className="text-xl text-gray-500">Browse thousands of quotes in an intuitive user interface</p>
                                </div>
                            </div>
                            <div className="flex items-start mb-10">
                                <div className="mt-2 mr-4">
                                ...
                                <div className="max-w-sm">
                                    ...
                                    <p className="text-xl text-gray-500">Search among our numerous quotes and bookmark your favorite ones </p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                ...
                                <div className="max-w-sm">
                                    <h3 className="mb-6 text-2xl font-semibold font-heading">Daily push notifications</h3>
                                    <p className="text-xl text-gray-500">Get push notifications every day to fuel your day</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="relative container px-4 mx-auto">
                    <div className="flex flex-wrap items-center -mx-4">
                        <div className="w-full md:w-2/5 px-4 mb-16 md:mb-0 translateY">
                            <Image layout='raw' className="h-96 lg:h-auto mx-auto object-contain" src={Screenshot2} alt="" />
                        </div>
                        <div className="w-full md:w-3/5 px-4">
                            <div className="max-w-max ml-auto">
                                <h2 className="mb-10 text-4xl font-semibold font-heading">dailyQ</h2>
                                <div className="max-w-xl mb-10">
                                    <p className="text-xl text-gray-500">Great quotes from great authors to boost your knowledge, your motivation </p>
                                </div>
                                <div className="flex justify-start items-center">
                                    <a className="mr-4" href={appStoreLink} target="_blank">
                                        <Image layout='raw' src={AppStoreLogo} alt="" />
